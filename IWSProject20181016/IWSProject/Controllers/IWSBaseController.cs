...
namespace IWSProject.Controllers
{
    public abstract class IWSBaseController : Controller
    {
        ...
        //         select new
        //         {
        //             i.MasterLogistic.id, i.MasterLogistic.oid, i.MasterLogistic.account, i.MasterLogistic.store,
        //             i.MasterLogistic.TransDate, i.MasterLogistic.ItemDate, i.MasterLogistic.EntryDate,
        //             i.MasterLogistic.oPeriode, i.Article.StockAccount, i.MasterLogistic.Company.purchasingclearingaccountid,
        //             sAmount = i.lineNet, i.MasterLogistic.Company.IBAN, IBAN2 = iban,
        //             i.MasterLogistic.oCurrency,  i.MasterLogistic.HeaderText
        //         }))
        //            group o by new
        //            {
        //                o.id, o.oid, o.account, o.store, o.TransDate, o.ItemDate, o.EntryDate,
        //                o.oPeriode, o.StockAccount, o.purchasingclearingaccountid, o.IBAN,
        //                o.IBAN2, o.oCurrency,  o.HeaderText
        //            } into g
        //            where g.Key.id == itemId
        //            select new JournalViewModel()
        //            {
