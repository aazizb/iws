namespace IWSProject.Controllers
{
    ...
    public class BankStatementsController : Controller
    {
        ...
        private bool MakeCustomerInvoice(int settlementId)
        {
            ...
            //MasterCompta customerInvoice = new MasterCompta
            //{
            //    oid = 0,
            ...
            //List<DetailCompta> lineCustomerInvoice = new List<DetailCompta>
            //{
            //    new DetailCompta
            //    {
            //        transid = itemID,
        ...
        private bool MakeVendorInvoice(int paymentId)
        {
            ...
            //List<DetailCompta> lineVendorInvoice = new List<DetailCompta>();
            ...
            //else
            //{
            //    lineVendorInvoice = new List<DetailCompta>
            //    {
            //        new DetailCompta
            //        {
            //            transid = itemID,
        ...
        private int MakePayment(int bankStatementId, int oid)
        {
            ...
            //MasterCompta payment = new MasterCompta
            //{
            //    oid = oid,
            ...
            //List<DetailCompta> linePayment = new List<DetailCompta>
            //{
            //    new DetailCompta
            //    {
            //        transid = itemID,
        ...
        private int MakeSettlement(int bankStatementId, int oid)
        {
            ...
            //MasterCompta settlement = new MasterCompta
            //{
            //    oid = oid,
            ...
            //List<DetailCompta> lineSettlement = new List<DetailCompta>
            //    {
            //        new DetailCompta
            //        {
            //            transid = itemID,
        ...
        private int MakeGeneralLedger(int bankStatementID, int oid)
        {
            ...
            //MasterCompta generalLedger = new MasterCompta
            //{
            //    oid = oid,
            //    CostCenter = "100", // to be confirmed
            ...
            //List<DetailCompta> lineGeneralLedger = new List<DetailCompta>
            //    {
            //        new DetailCompta
            //        {
            //            transid = itemID,
