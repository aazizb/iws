...
namespace IWSProject.Models.Entities
{
    ...
    public partial class Bank : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        [ColumnAttribute(Storage = "_name", DbType = "NVarChar(250) NOT NULL", CanBeNull = false)]
        public string name
        {
            get
            {
        ...
        [AssociationAttribute(Name = "Bank_BankAccount", Storage = "_BankAccounts", ThisKey = "id", OtherKey = "BIC")]
